...
describe Postcodesio do
  ...
  context 'requesting information on a single postcode works correctly' do
    ...
    it "should return a country which is one of the four constituent countries of the UK" do
      expect(@postcodesio.country).to eq ("England")||("Scottland")||("Northen Ireland")||("Wales")
    end
  ...
  context "multiple postcodes validation" do
    ...
    it "should return a country which is one of the four constituent countries of the UK" do
       expect(@postcodesio.two_country).to all eq ("England")||("Scottland")||("Northen Ireland")||("Wales")
       # ("England").or eq("Scottland").or eq ("Northen Ireland").or eq ("Wales")
    end
    ...
    it "should return a incode string of three characters" do
      expect(@postcodesio.two_incode).to all be <=3
    end


    it "should return a incode string of 3-4 characters" do
      expect(@postcodesio.two_incode).to all be_between(3, 4)
    end
  end
end
